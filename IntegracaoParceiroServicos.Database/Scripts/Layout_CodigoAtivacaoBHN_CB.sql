...
BEGIN	
  ...
  a:link {color:#0064b1;text-decoration:underline;}
  a:visited {color:#0064b1;text-decoration:underline;}
  a:focus {color:#0064b1 !important;}
...
<body bgcolor="#092055" style="margin: 0;padding: 0;-webkit-text-size-adjust: none;-ms-text-size-adjust: none;line-height: 1.6;">
	...
	<div align="center" style="font-family:Arial, sans-serif; color:#ffffff; font-size:11px; line-height:60px; height:60px; text-align:center;">
		Caso n&atilde;o visualize este e-mail, <a target="_blank" href="https://www.casasbahia.com.br" style="color:#ffffff;text-decoration:underline;">clique aqui</a>.
	</div>
	...
	<table border="0" width="100%" cellpadding="0" cellspacing="0" bgcolor="#092055" style="border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-spacing: 0;">
		<tr>      
			<td align="center" valign="top" bgcolor="#f6f2e7" style="background-color: #092055;border-collapse: collapse !important;" class="container">      
    			...
    			<tr>            
						<td background="https://www.casasbahia-imagens.com.br/html/news/black-howk/email/codigo-ativacao/header-left.jpg" width="429" height="232" style="color:#fff; font-family:Arial, sans-serif; border-collapse: collapse !important;">
                <div style="padding-left: 30px;">Voc&ecirc; adquiriu <span id="artigo">a</span>&nbsp;<strong><span id="produto">#(PRODUTO_NOME)</span><strong></div>
						</td>            
						<td style="border-collapse: collapse !important;">
							<a href="https://www.casasbahia.com.br" target="_blank" style="color: #de2042;text-decoration: none;">
								<img src="https://www.casasbahia-imagens.com.br/html/news/black-howk/email/codigo-ativacao/header-right.jpg" alt="Bem-vindo a Casas Bahia" width="211" height="232" border="0" class="destaque" style="display: block;border: none;outline: none;text-decoration: none;" />
							</a>
						</td>          
					</tr>        
		    </table>        
		    <table border="0" width="640" cellpadding="0" cellspacing="0" class="content-row" style="border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-spacing: 0;">          
              ...
              <div style="font-size:14px; color:#000000; text-align:left; width:288px; display: inline-block;">
                <strong>Ol&aacute;, <font color="#0a63a9">#(CLIE_NOME)</font></strong>
              </div>
              <div style="font-size:14px; color:#000000; text-align:right; width:288px; display: inline-block;">
                <strong>N&ordm; do pedido: <font color="#0a63a9">#(PED_CLIE_ORIG)</font></strong>
              </div>                    
              <br />    
            </td>          
          </tr>
          ...
          <tr>
            <td valign="top" class="container-padding" bgcolor="#ffffff" style="background-color: #ffffff;padding-left: 30px;padding-right: 30px;line-height: 20px;font-family: Arial, sans-serif;font-size: 14px;color: #434242;border-collapse: collapse !important;text-align: left;">
                ...
                <div style="color:#1274be; font-size: 20px; margin-top: 6px;">                     
          ...
          <tr>
            <td valign="top" class="container-padding" bgcolor="#ffffff" style="background-color: #ffffff;padding-left: 30px;padding-right: 30px;line-height: 20px;font-family: Arial, sans-serif;font-size: 14px;color: #434242;border-collapse: collapse !important;text-align: left;">
                <br />         
                <div style="color:#e68b00; font-family: tahoma, Arial, sans-serif; font-size: 16px;">                     
          ...
          <tr>
            <td valign="top" class="container-padding" bgcolor="#ffffff" style="background-color: #ffffff;padding-left: 30px;padding-right: 30px;line-height: 20px;font-family: Arial, sans-serif;font-size: 14px;color: #434242;border-collapse: collapse !important;text-align: left;">
                ...
                <div style="color:#5a5a5a; font-size: 16px; margin-top: 8px;">                     
                  Caso tenha qualquer d&uacute;vida, entre em <a href="mailto:atendimento@sac.casasbahia.com.br">contato conosco!</a>
                </div>    
                <br /> 
                <br />                
            </td>
          ...
          <tr>            
            <td valign="top" class="container-padding" bgcolor="#ffffff" style="background-color: #ffffff;padding-left: 30px;padding-right: 30px;line-height: 20px;font-family: Arial, sans-serif;font-size: 14px;color: #434242;border-collapse: collapse !important;text-align: left;">
              <table border="0" width="100%" cellpadding="0" cellspacing="0" class="content-row" style="border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-spacing: 0;">
                <tr>
                    <td width="50%" valign="top" class="container-padding" style="font-family:Arial, sans-serif; font-size:14px; color:#0d62a3; border-collapse:collapse !important; text-align: left;">
          ...
          <tr>
            <td valign="top" class="container-padding" bgcolor="#ffffff" style="background-color: #ffffff;padding-left: 30px;padding-right: 30px;line-height: 20px;font-family: Arial, sans-serif;font-size: 14px;color: #1274be;border-collapse: collapse !important;text-align: center;">
