...
BEGIN	
  ...
  a:link {color:#cd0050;text-decoration:underline;}
  a:visited {color:#cd0050;text-decoration:underline;}
  a:focus {color:#cd0050 !important;}
...
<body bgcolor="#e5e5e5" style="margin: 0;padding: 0;-webkit-text-size-adjust: none;-ms-text-size-adjust: none;line-height: 1.6;">
	...
	<div align="center" style="font-family:Arial, sans-serif; color:#666666; font-size:11px; line-height:60px; height:60px; text-align:center;">
		Caso n&atilde;o visualize este e-mail, <a target="_blank" href="https://www.barateiro.com.br" style="color:#666666;text-decoration:underline;">clique aqui</a>.
	</div>
	...
	<table border="0" width="100%" cellpadding="0" cellspacing="0" bgcolor="#092055" style="border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-spacing: 0;">
		<tr>      
			<td align="center" valign="top" bgcolor="#e5e5e5" style="background-color: #e5e5e5;border-collapse: collapse !important;" class="container">      
        <table width="640" border="0" cellspacing="0" cellpadding="0" class="content-row" style="border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-spacing: 0;">          
          <tr>            
            <td bgcolor="#cd0050" width="284" height="164" valign="top" style="color:#fff; font-family:Arial, sans-serif; border-collapse: collapse !important;">
              <a href="https://www.barateiro.com.br" target="_blank" style="color: #de2042;text-decoration: none; padding-top: 20px; display: block">
                 <img src="http://imagens.barateiro.com.br/news/black-howk/email/codigo-ativacao/header-left.jpg" alt="Bem-vindo a Casas Bahia" width="284" height="64" border="0" class="destaque" style="display: block;border: none;outline: none;text-decoration: none;" />
                </a>
            </td>            
            <td bgcolor="#cd0050" width="356" height="164" valign="top" style="border-collapse: collapse !important;">
                <div style="color:white; font-family:Arial, sans-serif; padding-top: 30px;padding-right: 30px; font-size: 22px; line-height: 26px; text-align: right;">Voc&ecirc; adquiriu <span id="artigo">a</span><br /><strong><span id="produto">#(PRODUTO_NOME)</span><strong></div>              
            </td>          
          </tr>        
        </table>         
		    <table border="0" width="640" cellpadding="0" cellspacing="0" class="content-row" style="border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-spacing: 0;">          
              ...
              <br /><br />            
              <div style="font-size:14px; color:#666666; text-align:left; width:288px; display: inline-block;">
                <strong>Ol&aacute;, <font color="#cd0050">#(CLIE_NOME)</font></strong>
              </div>
              <div style="font-size:14px; color:#666666; text-align:right; width:288px; display: inline-block;">
                <strong>N&ordm; do pedido: <font color="#cd0050">#(PED_CLIE_ORIG)</font></strong>
              </div>                    
              <br />    
            </td>          
          </tr>
          ...
          <tr>
            <td valign="top" class="container-padding" bgcolor="#ffffff" style="background-color: #ffffff;padding-left: 30px;padding-right: 30px;line-height: 20px;font-family: Arial, sans-serif;font-size: 14px;color: #666666;border-collapse: collapse !important;text-align: left;">
                ...
                <div style="color:#cd0050; font-size: 20px; margin-top: 6px;">                     
          ...
          <tr>
            <td valign="top" class="container-padding" bgcolor="#ffffff" style="background-color: #ffffff;padding-left: 30px;padding-right: 30px;line-height: 20px;font-family: Arial, sans-serif;font-size: 14px;color: #666666;border-collapse: collapse !important;text-align: left;">
                <br />         
                <div style="color:rgb(255, 196, 0); font-family: tahoma, Arial, sans-serif; font-size: 16px;">                     
          ...
          <tr>
            <td valign="top" class="container-padding" bgcolor="#ffffff" style="background-color: #ffffff;padding-left: 30px;padding-right: 30px;line-height: 20px;font-family: Arial, sans-serif;font-size: 14px;color: #666666;border-collapse: collapse !important;text-align: left;">
                ...
                <div style="color:#5a5a5a; font-size: 16px; margin-top: 8px;">                     
                  Caso tenha qualquer d&uacute;vida, entre em <a href="mailto:atendimento@sac.barateiro.com.br">contato conosco!</a>
                </div>    
                <br /> 
                <br />                
            </td>
          ...
          <tr>            
            <td valign="top" class="container-padding" bgcolor="#ffffff" style="background-color: #ffffff;padding-left: 30px;padding-right: 30px;line-height: 20px;font-family: Arial, sans-serif;font-size: 14px;color: #666666;border-collapse: collapse !important;text-align: left;">
              <table border="0" width="100%" cellpadding="0" cellspacing="0" class="content-row" style="border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-spacing: 0;">
                <tr>
                    <td width="50%" valign="top" class="container-padding" style="font-family:Arial, sans-serif; font-size:14px; color:#cd0050; border-collapse:collapse !important; text-align: left;">
          ...
          <tr>
            <td valign="top" class="container-padding" bgcolor="#ffffff" style="background-color: #ffffff;padding-left: 30px;padding-right: 30px;line-height: 20px;font-family: Arial, sans-serif;font-size: 14px;color: #cd0050;border-collapse: collapse !important;text-align: center;">
