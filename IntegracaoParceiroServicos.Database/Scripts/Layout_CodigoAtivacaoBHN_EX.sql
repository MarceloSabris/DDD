...
BEGIN	
  ...
  a:link {color:#48bac6;text-decoration:underline;}
  a:visited {color:#48bac6;text-decoration:underline;}
  a:focus {color:#48bac6 !important;}
...
<body bgcolor="#e5e5e5" style="margin: 0;padding: 0;-webkit-text-size-adjust: none;-ms-text-size-adjust: none;line-height: 1.6;">
	...
	<div align="center" style="font-family:Arial, sans-serif; color:#666666; font-size:11px; line-height:60px; height:60px; text-align:center;">
		Caso n&atilde;o visualize este e-mail, <a target="_blank" href="https://www.extra.com.br" style="color:#666666;text-decoration:underline;">clique aqui</a>.
	</div>
	...
	<table border="0" width="100%" cellpadding="0" cellspacing="0" bgcolor="#092055" style="border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-spacing: 0;">
        ...
        <table width="640" border="0" cellspacing="0" cellpadding="0" class="content-row" style="border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-spacing: 0;">          
          <tr>            
            <td background="http://www.extra-imagens.com.br/html/news/black-howk/email/codigo-ativacao/header-left.jpg" width="320" height="250" style="color:#fff; font-family:Arial, sans-serif; border-collapse: collapse !important;">
                <div style="padding-top: 30px;padding-left: 30px; font-size: 22px; line-height: 26px;">Voc&ecirc; adquiriu <span id="artigo">a</span><br /><strong><span id="produto">#(PRODUTO_NOME)</span><strong></div>
            </td>            
            <td style="border-collapse: collapse !important;">
              <a href="https://www.extra.com.br" target="_blank" style="color: #de2042;text-decoration: none;">
                <img src="http://www.extra-imagens.com.br/html/news/black-howk/email/codigo-ativacao/header-right.jpg" alt="Bem-vindo a Casas Bahia" width="320" height="250" border="0" class="destaque" style="display: block;border: none;outline: none;text-decoration: none;" />
              </a>
            </td>          
          </tr>        
        </table>         
		    <table border="0" width="640" cellpadding="0" cellspacing="0" class="content-row" style="border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-spacing: 0;">          
              ...
              <div style="font-size:14px; color:#666666; text-align:left; width:288px; display: inline-block;">
                <strong>Ol&aacute;, <font color="#48bac6">#(CLIE_NOME)</font></strong>
              </div>
              <div style="font-size:14px; color:#666666; text-align:right; width:288px; display: inline-block;">
                <strong>N&ordm; do pedido: <font color="#48bac6">#(PED_CLIE_ORIG)</font></strong>
              </div>                    
              <br />    
            </td>          
          </tr>
          ...
          <tr>
            <td valign="top" class="container-padding" bgcolor="#ffffff" style="background-color: #ffffff;padding-left: 30px;padding-right: 30px;line-height: 20px;font-family: Arial, sans-serif;font-size: 14px;color: #666666;border-collapse: collapse !important;text-align: left;">
                ...
                <div style="color:#48bac6; font-size: 20px; margin-top: 6px;">                     
          ...
          <tr>
            <td valign="top" class="container-padding" bgcolor="#ffffff" style="background-color: #ffffff;padding-left: 30px;padding-right: 30px;line-height: 20px;font-family: Arial, sans-serif;font-size: 14px;color: #666666;border-collapse: collapse !important;text-align: left;">
                <br />         
                <div style="color:#ffcc00; font-family: tahoma, Arial, sans-serif; font-size: 16px;">                     
          ...
          <tr>
            <td valign="top" class="container-padding" bgcolor="#ffffff" style="background-color: #ffffff;padding-left: 30px;padding-right: 30px;line-height: 20px;font-family: Arial, sans-serif;font-size: 14px;color: #666666;border-collapse: collapse !important;text-align: left;">
                ...
                <div style="color:#5a5a5a; font-size: 16px; margin-top: 8px;">                     
                  Caso tenha qualquer d&uacute;vida, entre em <a href="mailto:atendimento@sac.extra.com.br">contato conosco!</a>
                </div>    
                <br /> 
                <br />                
            </td>
          ...
          <tr>            
            <td valign="top" class="container-padding" bgcolor="#ffffff" style="background-color: #ffffff;padding-left: 30px;padding-right: 30px;line-height: 20px;font-family: Arial, sans-serif;font-size: 14px;color: #666666;border-collapse: collapse !important;text-align: left;">
              <table border="0" width="100%" cellpadding="0" cellspacing="0" class="content-row" style="border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-spacing: 0;">
                <tr>
                    <td width="50%" valign="top" class="container-padding" style="font-family:Arial, sans-serif; font-size:14px; color:#48bac6; border-collapse:collapse !important; text-align: left;">
          ...
          <tr>
            <td valign="top" class="container-padding" bgcolor="#ffffff" style="background-color: #ffffff;padding-left: 30px;padding-right: 30px;line-height: 20px;font-family: Arial, sans-serif;font-size: 14px;color: #48bac6;border-collapse: collapse !important;text-align: center;">
